...
regions: [
  {
    ...
    infoCard: {
      ...
      nohike: [
        ...
        { icon:'⚠️', name:'Oct 9–12 has no lodging booked', badge:'rb-must', badgeLabel:'Unbooked', sub:'The Jersey City Airbnb runs Oct 5–9 and the Hoboken Airbnb runs Oct 12–15. The three nights of <strong>Oct 9, 10 and 11 are not covered by any reservation</strong> — see the checklist. Also note the rental car goes back on Oct 5, so Oct 5–15 is a transit-only stretch.' },
      ]
    },
    days: ['d12', 'd13', 'd14', 'd15']
  },
  {
    id: 'adirondacks',
    emoji: '🏔',
...
days: {
  ...
  d12: {
    date: '2026-10-06', title: 'Jersey City base — Oct 6–8 still open',
    badge: 'flex', badgeLabel: 'Flex',
    content: [
      { type:'activity', icon:'🛏', title:'Based at 272 Hoboken Avenue Apt 8', sub:'Jersey City, NJ 07306 · booked through the morning of Fri Oct 9. Nothing is scheduled for Oct 6, 7 or 8 in the reservation documents — these three days are deliberately left open here rather than filled with invented plans.', url:'https://www.google.com/maps/search/?api=1&query=272+Hoboken+Avenue%2C+Jersey+City%2C+NJ+07306', urlLabel:'📍 Open in Google Maps' },
      { type:'activity', icon:'🚆', title:'Getting around without a car', sub:'The apartment is listed as PATH-accessible to Manhattan. Liberty State Park and the Statue of Liberty ferry, Newark Museum and Branch Brook Park are all in the region card above and reachable by transit or a short rideshare.' },
    ]
  },
  d13: {
    date: '2026-10-09', title: 'Checkout Jersey City — Oct 9–12 lodging NOT booked',
    badge: 'flex', badgeLabel: 'Gap',
    booked: [
      { label: 'Oct 9–12 lodging (3 nights) — nothing is booked; book this before the trip', must: true },
    ],
    content: [
      { type:'activity', icon:'🧳', title:'By 11:00am · Check out of 272 Hoboken Avenue Apt 8', sub:'272 Hoboken Avenue Apt 8, Jersey City, NJ 07306 · checkout is 11:00am on Fri Oct 9, confirmation HMMTENAE2T. Take everything — the next booked bed is not until Monday.', url:'https://www.google.com/maps/search/?api=1&query=272+Hoboken+Avenue%2C+Jersey+City%2C+NJ+07306', urlLabel:'📍 Open in Google Maps' },
      { type:'activity', icon:'⚠️', title:'Gap · Fri Oct 9 → Mon Oct 12, three nights with nowhere booked', sub:'This is a real hole in the plan, not an oversight in this dashboard. The reservation documents cover Oct 5–9 (Jersey City) and Oct 12–15 (Hoboken) and nothing in between: <strong>Oct 9, 10 and 11 have no lodging</strong>. No hotel has been invented here on purpose. Either extend one of the two Airbnbs, book something for the three nights, or confirm the family is hosting — and note the car is already returned, so whatever is chosen should be transit-reachable.' },
    ]
  },
  d14: {
    date: '2026-10-12', title: 'Check in — 452 1st Street, Hoboken',
    badge: 'flex', badgeLabel: 'Flex',
    content: [
      { type:'activity', icon:'🏠', title:'From 4:00pm · Check in at 452 1st Street Apt 3, Hoboken', sub:'452 1st Street Apt 3, Hoboken, NJ 07030 · check-in from 4:00pm Mon Oct 12, checkout 11:00am Thu Oct 15. Airbnb “Jazz Suite — King Bed Studio, 15 Min to NYC”, confirmation HMT9MD8KEN, 4 guests, paid $773.39. Host: Luxanto Vacation Rentals (Shawn Cunningham), +1 702-895-7777.', url:'https://www.google.com/maps/search/?api=1&query=452+1st+Street%2C+Hoboken%2C+NJ+07030', urlLabel:'📍 Open in Google Maps' },
      { type:'activity', icon:'🚆', title:'Moving over from wherever Oct 9–12 lands', sub:'No car — plan the transfer as PATH, light rail or a rideshare with the luggage. Hoboken Terminal is a short ride from 1st Street and connects to PATH, NJ Transit and the ferries.' },
      { type:'activity', icon:'🗽', title:'Oct 13–14 · last two open days', sub:'Nothing booked for Oct 13 or 14. Held open here rather than filled in — the NJ region card above lists the transit-friendly options.' },
    ]
  },
  d15: {
