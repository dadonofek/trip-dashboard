...
pois: [
  ...
  // — Lake Placid: groceries, clothes & essentials —
  { lat:44.2973, lng:-73.9992, tier:2, cat:'food',     icon:'🛒', name:'Hannaford — Lake Placid',       area:'45 Hadjis Way, Lake Placid, NY', fav:true, sub:'⭐ Favorite. Convenient full supermarket in the village. Daily 7am–11pm. Combine with Marshalls, same shopping area.', gq:'Hannaford, 45 Hadjis Way, Lake Placid NY' },
  { lat:44.2973, lng:-73.9992, tier:2, cat:'activity', icon:'🛍', name:'Marshalls — Lake Placid',       area:'45 Hadjis Way, Lake Placid, NY', sub:'Worth checking for warm clothes for the girls and yourselves; sizes and stock vary. Daily 9:30am–9:30pm, same shopping area as Hannaford.', gq:'Marshalls, 45 Hadjis Way, Lake Placid NY' },
  { lat:44.2955, lng:-74.0096, tier:2, cat:'activity', icon:'💊', name:'Kinney Drugs',                  area:'1954 Saranac Ave, Lake Placid, NY', sub:'Pharmacy and toiletries.', gq:'Kinney Drugs, 1954 Saranac Ave, Lake Placid NY' },
  ...
  // — Adirondacks: food —
  { lat:44.2786, lng:-73.9822, tier:3, cat:'food', icon:'🥪', name:'Big Mountain Deli & Creperie', area:'2475 Main St, Lake Placid, NY', fav:true, sub:'⭐ Favorite — ChatGPT\'s pick for an easy family lunch downtown. Crêpes, sandwiches, smoothies. Kid-friendly, quick. Currently 8am–3pm daily.', url:'https://order.toasttab.com/online/big-mountain-deli-creperie-2475-main-street' },
  { lat:44.2955, lng:-73.9980, tier:3, cat:'food', icon:'🥪', name:'Simply Gourmet',                area:'2099 Saranac Ave, Lake Placid, NY', sub:'Convenient breakfast or takeaway sandwiches near the Lake Placid Inn. Daily 8am–3pm.', gq:'Simply Gourmet, 2099 Saranac Ave, Lake Placid NY' },
  ...
  { lat:44.2839, lng:-73.9966, tier:3, cat:'food', icon:'🍝', name:'Caffe Rustica',                area:'1936 Saranac Ave, Lake Placid, NY', sub:'House-made pasta & seafood. Best Italian in the Adirondacks. Daily 5–9pm, dinner only — reserve an early table.', url:'https://www.rusticalp.com/menu' },
  { lat:44.2842, lng:-73.9821, tier:3, cat:'food', icon:'🌊', name:'The Cottage at Mirror Lake',   area:'77 Mirror Lake Dr, Lake Placid, NY', fav:true, sub:'⭐ Favorite — ChatGPT\'s pick for a relaxed meal with lake views; kids\' menu. Walk-ins only, closed Mondays.', gq:'The Cottage, 77 Mirror Lake Dr, Lake Placid NY' },
  ...
  { lat:44.2711, lng:-74.0093, tier:3, cat:'food', icon:'🍕', name:'Lisa G\'s',                    area:'6125 Sentinel Rd, Lake Placid, NY', sub:'Casual American food and pizza; another dinner option. Open Sat from 11:30am; pizzas/mains start 4pm.', gq:'Lisa Gs, 6125 Sentinel Rd, Lake Placid NY' },
  { lat:44.2878, lng:-73.9851, tier:3, cat:'food', icon:'🍦', name:'Emma\'s Lake Placid Creamery',  area:'Main St, Lake Placid, NY', fav:true, sub:'⭐ Favorite. Local tourism guide highlights the maple ice cream — a treat during your town walk.', gq:'Emmas Lake Placid Creamery, Main St, Lake Placid NY' },
...
regions: [
  ...
  },
  {
    ...
    infoCard: {
      prefix: 'adk',
      eat: [
        { icon:'🥪', name:'Big Mountain Deli &amp; Creperie',    badge:'rb-fav', badgeLabel:'⭐ Favorite',  sub:'2475 Main St · Crêpes, sandwiches, smoothies, vegetarian options. Kid-friendly, quick turnover. Sun–Thu 8am–3pm, Fri–Sat 8am–5pm.', url:'https://order.toasttab.com/online/big-mountain-deli-creperie-2475-main-street' },
        ...
        { icon:'🌊', name:'The Cottage at Mirror Lake',          badge:'rb-fav', badgeLabel:'⭐ Favorite',  sub:'77 Mirror Lake Dr · American food with lakeside patio views. Perfect for a relaxed dinner.', url:'https://www.toasttab.com/local/order/mirror-lake-inn-resort-and-spa-the-cottage-77-mirror-lake-drive' },
        ...
        { icon:'🍕', name:'Lisa G\'s',                            badge:'rb-casual', badgeLabel:'Casual',  sub:'6125 Sentinel Rd · Casual American food and pizza. Open Sat from 11:30am; pizzas/mains start 4pm.' },
        { icon:'🍦', name:'Emma\'s Lake Placid Creamery',         badge:'rb-fav', badgeLabel:'⭐ Favorite',  sub:'Main St · Local favorite for maple ice cream — a treat during your town walk.' },
      ],
      nohike: [
    ...
    content: [
      ...
      { type:'hiketabs', prefix:'d2-nature', tabs:[
        { id:'heaven-orchard', label:'Heaven Hill — Old Orchard', active:true,
          ...
          linkLabel:'📍 Trailhead info &amp; directions',
          navUrl:'https://www.alltrails.com/trail/us/new-york/heaven-hills-trail',
