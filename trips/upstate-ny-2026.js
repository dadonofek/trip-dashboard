...
days: {
  ...
  d2: {
    ...
    content: [
      ...
      { type:'activity', icon:'🌙', title:'Early evening · Early dinner + race prep', sub:'Early dinner, lay out race gear and bib, early night ahead of the 9am half marathon start in Schroon Lake.' },
  ...
  d3: {
    ...
    content: [
      ...
      { type:'activity', icon:'🏁', title:'9:00am · Half marathon start — town of Adirondack', sub:'Point-to-point course starting in the town of Adirondack and finishing in Schroon Lake. Arrive with time to park, warm up and find the family cheering spot near the finish.', url:'https://www.adirondackmarathon.org/half-marathon' },
